import { View, Dimensions, Text, Appearance } from 'react-native';
...
export const SplashTemp = () => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colorScheme === 'dark' ? 'black' : 'white', padding: 20, justifyContent: 'center' }}>
      ...
      <View style={{ flexDirection: 'row', marginTop: width * 0.04 }}>
        <View style={{ alignItems: 'center', width: '100%' }}>
          <View style={{flexDirection: 'row', alignItems: 'center'}}>
            <Text style={{ fontWeight: '400', color: colorScheme === 'dark' ? 'white' : colores.Pantone_382_C, fontSize: width * 0.085 }}>En mantenimiento!</Text>
          </View>
