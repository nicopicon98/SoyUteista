...
export class Tutorias{
   ...
   */
  public static getAllCourses = async (sede: string): Promise<ICourse[]> => {
   ...
   */
  public static getDaysByAsignatura = async (id_curso: string, sede: string): Promise<IDaysByAsignatura[]> => {
   ...
   */
  public static getFranjaByDayAsignatura = async (id_curso: string, day: string, sede: string): Promise<IFranjaByDayAsignatura[]> => {
   ...
   */
  public static getAllTutors = async (id_curso: string, day: string, franja: string, sede: string): Promise<ITutor[]> => {
   ...
   */
  public static getInfoTutor = async (id_course: string, day: string, franja: string, id_tutor: string, sede: string): Promise<ITutorInfoResp> => {
   ...
   */
  public static getAllTutoriasByUser = async (id: string): Promise<ITutoriaResp> => {
  ...
  public static postInsertTutoria = async (obj: ICreateCita): Promise<any> => {
    const resp: AxiosResponse<any, any> = await tutoriasAPI.post('/crear_cita.php', obj)
    return resp.data
  }
